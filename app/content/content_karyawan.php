                                        ...
                                        <tr>
											...
											<div class="btn-group">
												...
												<ul class="dropdown-menu">
													...
													<li><a href="controller/karyawan_hapus?id=<?= $d_karyawan['id'];?>" onclick="return confirm('Apakah NIK <?= $d_karyawan['nik'];?> akan dihapus ?')">Hapus</a></li>
												</ul>
											</div>
											<?php 
											...
											<div class="btn-group">
												...
												<ul class="dropdown-menu">
													...
													<li><a href="karyawan_detail?nik=<?= $d_karyawan['nik'];?>">Detail</a></li>
													<li><a href="controller/karyawan_hapus?id=<?= $d_karyawan['id'];?>" onclick="return confirm('NIK <?= $d_karyawan['nik'];?> akan dihapus ?')">Hapus</a></li>
												</ul>
											</div>
											<?php
												;} else{ echo'';}
											...
											<form action="controller/karyawan_edit" class="form-horizontal" method="POST" enctype="multipart/form-data">
												<div class="row clearfix">
													...
													<div class="col-sm-3">
														<div class="form-group">
															<div class="form-line">
																<input type="text" id="nik" name="nik" readonly="readonly" class="form-control" placeholder="Masukan NIK" required>
															</div>
														</div>
													</div>
												</div>
