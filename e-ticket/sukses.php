...
setTimeout("location.href='index'", 20000);
</script>	
	<div>
		<div class="container">
			<div class="logo">
			...
			<div class="content-grids">
					...
					<div class="col-md-8 content-middle">
						<div class="clock-grids">
							...
							<div class="clock-center">
								...
								<p align="center"><b>KUPON DOORPRIZE ANDA :</b></p>
								<h2><p align="center"><b><?= $karyawan['nik'];?></b></p></h2>
				...
				<div class="copyright" >
					<p>© 2024 <?= $app['nama_perusahaan'];?> . All Rights Reserved <img src="images/botom.webp" alt="Image"></p>
				</div>
			</div>
		</div>
	</div>
	...
	<script language="javascript">
		...
		$(document).ready(function(){
			...
			$('#myclock').thooClock({
				...
				showNumerals:true,
				brandText:'PT Mada Wikri Tunggal',
